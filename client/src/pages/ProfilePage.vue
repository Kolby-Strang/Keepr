        ...
        <div class="row mt-3 px-0 mx-0 px-md-5 mx-md-5">
            <div class="col-12 profile-cover-container">
                <img class="cover-img rounded"
                    :src="profile.coverImg ? profile.coverImg : 'https://cdn.vectorstock.com/i/preview-1x/65/30/default-image-icon-missing-picture-page-vector-40546530.jpg'"
                    :alt="`Cover image for ${profile.name}`">
                <img class="profile-img box-shadow" :src="profile.picture" :alt="`Profile image for ${profile.name}`">
            </div>
