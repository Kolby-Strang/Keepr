...
export default {
    ...
    setup(props) {
        function openVaultKeepModal() {
            vaultKeepsService.setActiveVaultKeep(props.vaultKeep)
            Modal.getOrCreateInstance('#vaultKeepDetails').show()
        }
        return { openVaultKeepModal }
    }
};
</script>
